...
import { Column, Container, TextLogin, Row, SubtitleLogin, Title, TitleLogin, Wrapper, Text, ColumnTermos } from "./styles";
        ...
        <Container>
            ...
            <Column>
                <Wrapper>
                    ...
                    <Row>
                        <TextLogin> Já tenho conta. <Text> Fazer login </Text> </TextLogin> 
